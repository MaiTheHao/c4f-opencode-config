...
- **Use context from session history**: when resuming a session, pay attention to previous messages, fixes, results, and any context recorded in that session. Do not assume a fresh start unless explicitly requested.